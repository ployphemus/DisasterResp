/**
 * This script is the original shelters_script.js file that was used to render the map on the shelters page. This shouldn't be used but only for reference.
 */
let map;
let service;
let markers = [];
