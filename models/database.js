...
// Add user
database.post("/registeruser", (req, res) => { // Changed to POST for adding a user
    let user = {
...
database.put("/updateuserlocation/:id", (req, res) => { // Changed to PUT
...
// Update user details
database.put("/updateuser/:id", (req, res) => { // Changed to PUT
...
database.put("/updateshelter/:id", (req, res) => { // Changed to PUT
